...
export class Convert {
    public static toISearchGifs(json: string): ISearchGifs {
        return cast(JSON.parse(json), r("ISearchGifs"));
    }

    public static iSearchGifsToJson(value: ISearchGifs): string {
        return JSON.stringify(uncast(value, r("ISearchGifs")), null, 2);
    }
}
